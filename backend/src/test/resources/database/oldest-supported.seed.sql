-- The rows the migration fixture holds. Chosen for what tends to break a migration rather than for
-- what is typical: both ends of the count's range, zero, and ids the service would never have
-- generated itself.
