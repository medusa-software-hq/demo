-- The oldest database this app still has to migrate from: version 1, holding
-- the rows in oldest-supported.seed.sql. Generated, not written by hand:
--
...
1	1	create counters	SQL	V1__create_counters.sql	1952171312	test	2026-09-13 16:38:14.251942	11	t
\.
